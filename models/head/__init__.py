...
from .anchor_head_embed import AnchorHeadSingleEmbedding
from .anchor_head_KD import AnchorHeadKnowledgeDistill
...
__all__ = {
    ...
    'AnchorHeadSingleEmbedding': AnchorHeadSingleEmbedding,
    'AnchorHeadKnowledgeDistill': AnchorHeadKnowledgeDistill,
}
